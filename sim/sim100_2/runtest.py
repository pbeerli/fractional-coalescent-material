...
#                os.system("launch ./migrate-n-mpi  parmfile_{0}_{1} log_{0}_{1} 101 4:00:00".format(alpha,alpha2))
                os.system("launch ./migrate-n-mpi  parmfile_{0}_{1} log_{0}_{1} 40 100:00:00".format(alpha,alpha2))
